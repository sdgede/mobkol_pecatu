  ...
  List dataSetting() {
    return [
      ListModelKol(
        ...
        key: GlobalKey(),
        description: 'Klik disini untuk mengkoneksikan printer bluetooth'
      ),
      ListModelKol(
        type: 'MIGRASI_DATA',
        title: 'Data Migrasi',
        ...
        key: GlobalKey(),
        description: 'Klik disini untuk mengupdate data nasabah,produk & konfigurasi offline'
      ),
      ListModelKol(
        ...
        key: GlobalKey(),
        description: 'Klik disini untuk mendownload data offline'
      ),
      ListModelKol(
        type: 'ABOUT',
        ...
        key: GlobalKey(),
        description: 'Klik disini untuk melihat informasi aplikasi'
      ),
      ListModelKol(
        type: 'LOGOUT',
        title: 'Log Out',
        ...
        key: GlobalKey(),
        description: 'Klik disini untuk keluar dari aplikasi'
      ),
    ];
  }
  ...
  List dataMenuKolektor() {
    return [
      ListModelKol(
        ...
        key: GlobalKey(),
        description: 'Klik disini untuk melakukan transaksi kolektor via nomor rekening'
      ...
      ListModelKol(
        ...
        key: GlobalKey(),
        description: 'Klik disini untuk melihat history transaksi kolektor'
      ),
      ListModelKol(
        type: 'SALDOKOL',
        ...
        key: GlobalKey(),
        description: 'Klik disini untuk melihat saldo kolektor'
      ),
      ListModelKol(
        ...
        key: GlobalKey(),
        description: 'Klik disini untuk melakukan pencarian nama nasabah'
      ),
      // ListModelKol(
      //   type: 'DATA_PENAGIHAN',
